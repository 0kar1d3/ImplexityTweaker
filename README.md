...
* **🗔 Быстрая настройка Windows:** Мгновенное применение самых востребованных настроек:
...
* **🎮 Игровая оптимизация:** Настройка системы для максимального FPS и снижения инпут-лага..
...
Размер файла составляет **182 МБ**, и вот почему это круто:

1. **Zero Dependencies:** Вам **не нужно** скачивать или устанавливать .NET Runtime. Все необходимые библиотеки уже вшиты в один `.exe`.
2. **Modern UI:** Вес обусловлен использованием библиотеки **WPF-UI**, которая обеспечивает нативный Fluent Design в стиле Windows 11.
